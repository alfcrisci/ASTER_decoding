...
# parma_pop=readRDS("data/parma_pop.rds")
# 
...
# parma_pop[[1]]$count=1
# 
# saveRDS(parma_pop,"data/parma_pop.rds")
# 
# ########################################################################################################################################
...
# 
# write.csv(table_2014,"data/table_2014_parma_class.csv",row.names = F)
# write.csv(table_2015,"data/table_2015_parma_class.csv",row.names = F)
# write.csv(diff_table,"data/diff_table_2015_2014_parma_class.csv",row.names = F)
# 
# saveRDS(table_2014,"data/table_2014_parma_class.rds")
# saveRDS(table_2015,"table_2015_parma_class.rds")
# saveRDS(diff_table,"data/diff_table_2015_2014_parma_class.rds")
...
diff_table=readRDS("data/diff_table_2015_2014_parma_class.rds")


sez_censuarie_parma=readRDS("data/sez_censuarie_parma_32N.rds")
...
saveRDS(sez_censuarie_geo_full_ls,"data/sez_censuarie_data_ls.rds")
...
saveRDS(building_caire_geo_civ_ls,"data/building_caire_civ_data_ls.rds")
...
##############################################################################################################################################################
building_caire_geo_civ_ls=readRDS("data/building_caire_civ_data_ls.rds")
...
griglia_geo=readRDS("data/griglia_geo.rds")

confini_comune_geo=readRDS("data/confini_comune_geo.rds")
confini_comune_ls=readRDS("data/confini_comune_landsat.rds")
building_caire_geo_civ_ls=readRDS("data/building_caire_civ_data_ls.rds")
sez_censuarie_geo_full_ls=readRDS("data/sez_censuarie_data_ls.rds")
...
proj_caire_CRS=readRDS("data/proj_caire.rds")
...
saveRDS(sez_censuarie_EM_data,"data/sez_censuarie_EM_data.rds")
saveRDS(buildcivparma_EM_data,"data/buildcivparma_EM_data.rds")
saveRDS(sez_censuarie_geo_data,"data/sez_censuarie_geo_data.rds")
saveRDS(buildcivparma_geo_data,"data/buildcivparma_geo_data.rds")
...
lottizzazioni=readRDS("data/Lottizzazioni_ls.rds")
PEEP=readRDS("data/PEEP_ls.rds")
...
parma_consumo_suolo12=raster("data/parma_consumo_suolo_2012.tif")
parma_consumo_suolo15=raster("data/parma_consumo_suolo_2015.tif")

parma_lst_2015=readRDS("data/parma_city_lst_15_07_2015.rds")
...
writeRaster(diff_parma_consumo_suolo, filename="data/diff15-12_parma_consumo_suolo_mask.tif", overwrite=TRUE)
